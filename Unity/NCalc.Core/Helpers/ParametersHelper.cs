...
namespace NCalc.Helpers
{
    ...
    public static class ParametersHelper
    {
        ...
        public static Dictionary<string, IEnumerator> GetEnumerators(IDictionary<string, object?> parameters,
            out int? size)
        {
            ...
            foreach (KeyValuePair<string, object?> parameter in parameters)
            {
                ...
                List<object> list = enumerable as List<object> ?? enumerable.Cast<object>().ToList();
