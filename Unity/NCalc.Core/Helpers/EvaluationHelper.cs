...
namespace NCalc.Helpers
{
    ...
    public static class EvaluationHelper
    {
        ...
        public static object? Plus(object? leftValue, object? rightValue, ExpressionContextBase context)
        {
            ...
            {
                return string.Concat(Convert.ToString(leftValue, context.CultureInfo),
                    Convert.ToString(rightValue, context.CultureInfo));
            }
        ...
        public static bool In(object? rightValue, object? leftValue, ExpressionContextBase context)
        {
            return rightValue switch
            {
                ...
                { } rightValueObject => Contains(leftValue, new List<object?> { rightValueObject }.AsReadOnly(), context),
        ...
        {
            object?[] rightArray = rightValue as object[] ?? rightValue.ToArray();

            bool noStringTypeCoercion = context.Options.HasFlag(ExpressionOptions.NoStringTypeCoercion);
            ...
            if (rightArray.All(v => v is string))
            {
                ...
                return rightArray.OfType<string>().Contains(
        ...
        /// </returns>
        /// <remarks>
        /// The comparison is case-insensitive if the <see cref="ExpressionOptions.CaseInsensitiveStringComparer" /> flag is set in
        ...
        public static bool Like(string value, string pattern, ExpressionContextBase context)
        {
            ...
            RegexOptions options = context.Options.HasFlag(ExpressionOptions.CaseInsensitiveStringComparer)
